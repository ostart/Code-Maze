...
public static class BasketApiEndpoints
{
    ...
    {
        routeBuilder.MapGet("/{customerId}", GetBasket).RequireAuthorization();
        ...
        routeBuilder.MapDelete("/{customerId}/{productId}", DeleteBasketProduct).RequireAuthorization();
        
        routeBuilder.MapDelete("/{customerId}", DeleteBasket).RequireAuthorization();
    }
