...
public interface ICompanyService
{
    ...
    Task<OneOf<CompanyDto, CompanyNotFoundResponse>> GetCompanyAsync(Guid companyId, bool trackChanges, 
    ...
    Task<OneOf<Success, CompanyNotFoundResponse>> DeleteCompanyAsync(Guid companyId, bool trackChanges, CancellationToken ct = default);
    Task<OneOf<Success, CompanyNotFoundResponse>> UpdateCompanyAsync(Guid companyid, CompanyForUpdateDto 
        companyForUpdate, bool trackChanges, CancellationToken ct = default);
}